...
#ifndef USER_SETTINGS_WOLFTPM_H
#define USER_SETTINGS_WOLFTPM_H
...
/* enable U-boot with wolfTPM */
#undef CONFIG_TPM_WOLF
#define CONFIG_TPM_WOLF

/* No wolfcrypt with U-boot */
